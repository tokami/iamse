---
title: "Getting started with iamse"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting started with iamse}
...
- `"conscat"`: constant catch if the assessment model does not converge
...
## Constant catch if the assessment (e.g. spict) does not converge
iamse::def.hcr.conscat(set. = set)
