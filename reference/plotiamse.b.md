...
display median trajectories, uncertainty envelopes, and optional
...
- trendline:
  ...
  highlighting the general trajectory of biomass over time (e.g. using a
...
- med:
  ...
  Logical; if \`TRUE\`, draw the median biomass trajectory across
...
- ylab:
  ...
  Character string specifying the y-axis label. Default is \`"Total
  biomass"\`.
